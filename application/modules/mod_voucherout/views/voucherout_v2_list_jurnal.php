<div class="content form_voucherout_list_jurnal">
    <?= form_open(); ?>
    <div class="row-fluid">
        <div class="span12">
            <div class="box">
                <div class="red box_title"><h4><span>#</span> Voucher Out</h4></div>
                <div class="red box_content form_search" ></div>
            </div>
        </div>
    </div>
    <div class="row-fluid">
...
<script type="text/javascript">
    function edit_jurnal(gid) {
        $.ajax({
            url: root + 'mod_voucherout/edit_jurnal',
            type: 'post',
            dataType: 'json',
            data: {
                nobukti: gid,
    ...
    function form_refresh_grid() {
        ...
        jQuery("#list2").jqGrid('setGridParam', {
            url: root + 'mod_voucherout/JurnalToJson?_search=true&' + data,
            page: 1
        }).trigger("reloadGrid");
    }
    ...
    $(document).ready(function() {
        ...
        jQuery("#list2").jqGrid({
            url: root + 'mod_voucherout/JurnalToJson',
            mtype: "post",
            datatype: "json",
