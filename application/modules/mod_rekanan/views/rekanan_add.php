                ...
                <div class="basic box_content form-horizontal">
                    ...
                    <div class="row-fluid">
                        <div class="control-group info">
                            ...
                            <div class="controls">
                                <input class="span8 text" type="text" id="kode_rekanan" name="kode_rekanan" value="<?= set_value('kode_rekanan'); ?>" readonly autocomplete="off" />
                            </div>
                        </div>
                    </div>
                    <div class="row-fluid">
                    ...
                    <div class="row-fluid">
                        <div class="control-group info">
                            ...
                            <div class="controls">
                                <input class="span8 text" type="text" id="nomor_kontrak" name="nomor_kontrak" value="<?= set_value('nomor_kontrak'); ?>" autocomplete="off" />
                            </div>
                        </div>
                    </div>
                    <div class="row-fluid">
                        <div class="control-group info">
                            ...
                            <div class="controls">
                                <input class="span8 text" type="text" id="nilai_kontrak" name="nilai_kontrak" value="<?= set_value('nilai_kontrak'); ?>" autocomplete="off" />
                            </div>
                        </div>
                    </div>
                    <div class="row-fluid">
