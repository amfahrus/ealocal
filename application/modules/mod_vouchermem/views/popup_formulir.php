...
<div id="form_popupformulir" class="table-responsive">
  <h3 class="warna"><center>Bukti Memorial</center></h3>
  ...
  <table class="table">
    <thead>
      <tr>
        ...
        <th class="warna" width="10%"><center>Kode Perkiraan Debet</center></th>
        <th class="warna" width="10%"><center>Kode Perkiraan Kredit</center></th>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><?php echo $row["detail"]["D"]["kdperkiraan"];?></td>
    ...
    <tfoot>
      <tr>
        <th class="warna" colspan="4"><center>Total</center></th>
