			...
			switch ($nobukti) {
				...
				default:
					...
					foreach($jurnal as $key => $val){
						...
						// Otomatisasi Piutang JO/KSO Debet Proyek ke Proyek atau KP ke Proyek
						if($val["dk"] == "D" && in_array($val["dperkir_id"], $dperkir_piutangkso) and (strpos($val["nobukti"], 'HTS')) === false and (strpos($val["nobukti"], 'PUS')) === false and (strpos($val["nobukti"], 'RKS')) === false and $is_proyek_online and $kat_proyek == 2){
							$jurnal_piutangkso[] = array(
								'tanggal' => $val["tanggal"],
								'nobukti' => "PU".$val["nobukti"],
								'dperkir_id' => 485,
								'id_proyek' => $idproyek_alokasi,
								'kdnasabah' => $kdnasabah_alokasi,
								'keterangan' => str_replace("'","`",$val["keterangan"]),
								'dk' => 'K',
								'is_delete' => 't',
								'rupiah' => $val["rupiah"] * -1,
								'create_id' => $val["create_id"],
							...
							$this->vouchermem_model->deleteJurnal("PU".$val["nobukti"]);
						}

						// Otomatisasi Piutang JO/KSO Debet Proyek ke KP
						if($val["dk"] == "D" && in_array($val["dperkir_id"], $dperkir_piutangkso) and (strpos($val["nobukti"], 'HTS')) === false and (strpos($val["nobukti"], 'PUS')) === false and (strpos($val["nobukti"], 'RKS')) === false and $is_proyek_online and $kat_proyek == 12){
							$jurnal_piutangkso[] = array(
								'tanggal' => $val["tanggal"],
								'nobukti' => "PU".$val["nobukti"],
								'dperkir_id' => 488,
						...
						// Otomatisasi Hutang JO/KSO Debet Proyek ke Proyek atau KP ke Proyek
						if($val["dk"] == "D" && in_array($val["dperkir_id"], $dperkir_hutangkso) and (strpos($val["nobukti"], 'HTS')) === false and (strpos($val["nobukti"], 'PUS')) === false and (strpos($val["nobukti"], 'RKS')) === false and $is_proyek_online and $kat_proyek == 2){
							$jurnal_hutangkso[] = array(
								'tanggal' => $val["tanggal"],
								'nobukti' => "HT".$val["nobukti"],
								'dperkir_id' => 113,
								'id_proyek' => $idproyek_alokasi,
								'kdnasabah' => $kdnasabah_alokasi,
								'keterangan' => str_replace("'","`",$val["keterangan"]),
							...
							$this->vouchermem_model->deleteJurnal("HT".$val["nobukti"]);
						}

						// Otomatisasi Piutang JO/KSO Debet Proyek ke KP
						if($val["dk"] == "D" && in_array($val["dperkir_id"], $dperkir_hutangkso) and (strpos($val["nobukti"], 'HTS')) === false and (strpos($val["nobukti"], 'PUS')) === false and (strpos($val["nobukti"], 'RKS')) === false and $is_proyek_online and $kat_proyek == 12){
							$jurnal_hutangkso[] = array(
								'tanggal' => $val["tanggal"],
								'nobukti' => "HT".$val["nobukti"],
								'dperkir_id' => 116,
						...
						// Otomatisasi Piutang JO/KSO Kredit Proyek ke Proyek atau KP ke Proyek
						if($val["dk"] == "K" && in_array($val["dperkir_id"], $dperkir_piutangkso) and (strpos($val["nobukti"], 'HTS')) === false and (strpos($val["nobukti"], 'PUS')) === false and (strpos($val["nobukti"], 'RKS')) === false and $is_proyek_online and $kat_proyek == 2){
							$jurnal_piutangkso[] = array(
								'tanggal' => $val["tanggal"],
								'nobukti' => "PU".$val["nobukti"],
								'dperkir_id' => 485,
						...
						// Otomatisasi Piutang JO/KSO Kredit Proyek ke KP
						if($val["dk"] == "K" && in_array($val["dperkir_id"], $dperkir_piutangkso) and (strpos($val["nobukti"], 'HTS')) === false and (strpos($val["nobukti"], 'PUS')) === false and (strpos($val["nobukti"], 'RKS')) === false and $is_proyek_online and $kat_proyek == 12){
							$jurnal_piutangkso[] = array(
								'tanggal' => $val["tanggal"],
								'nobukti' => "PU".$val["nobukti"],
								'dperkir_id' => 488,
						...
						// Otomatisasi Hutang JO/KSO Kredit Proyek ke Proyek atau KP ke Proyek
						if($val["dk"] == "K" && in_array($val["dperkir_id"], $dperkir_hutangkso) and (strpos($val["nobukti"], 'HTS')) === false and (strpos($val["nobukti"], 'PUS')) === false and (strpos($val["nobukti"], 'RKS')) === false and $is_proyek_online and $kat_proyek == 2){
							$jurnal_hutangkso[] = array(
								'tanggal' => $val["tanggal"],
								'nobukti' => "HT".$val["nobukti"],
								'dperkir_id' => 113,
						...
						// Otomatisasi Piutang JO/KSO Kredit Proyek ke KP
						if($val["dk"] == "K" && in_array($val["dperkir_id"], $dperkir_hutangkso) and (strpos($val["nobukti"], 'HTS')) === false and (strpos($val["nobukti"], 'PUS')) === false and (strpos($val["nobukti"], 'RKS')) === false and $is_proyek_online and $kat_proyek == 12){
							$jurnal_hutangkso[] = array(
								'tanggal' => $val["tanggal"],
								'nobukti' => "HT".$val["nobukti"],
								'dperkir_id' => 116,
					...
					if (($kredit === $debet)) {
						...
						if(count($jurnal_piutangkso)){
							$insert_alokasi = $this->vouchermem_model->InsertJurnal($jurnal_piutangkso);
								if($insert_alokasi){
									$this->cleanTransaksi();
									$data['success'] = '<p>Jurnal Alokasi '.$transaksi["no_dokumen"].' berhasil disimpan dengan nomor bukti : '.$nobukti.'</p>';
								} else {
						...
						if(count($jurnal_hutangkso)){
							$insert_alokasi = $this->vouchermem_model->InsertJurnal($jurnal_hutangkso);
								if($insert_alokasi){
									$this->cleanTransaksi();
									$data['success'] = '<p>Jurnal Alokasi '.$transaksi["no_dokumen"].' berhasil disimpan dengan nomor bukti : '.$nobukti.'</p>';
								} else {
