...
class vouchermem_model extends CI_Model {
    ...
    public function InsertJurnal($data){
        ...
        $this->dataset_db->insert_logs(
										array(
											...
											'log_description' => 'User menambahkan jurnal voucher memorial',
	...
	public function deleteJurnal($nobukti){
        ...
        $this->dataset_db->insert_logs(
										array(
											'log_username' => $this->session->userdata('ba_username'),
											'log_node' => $_SERVER['REMOTE_ADDR'],
											'log_description' => 'User menghapus jurnal voucher memorial',
	...
	public function getJurnal($idproyek, $limit, $offset, $sidx, $sord, $cari, $search = "false") {
        ...
        $this->db->where('tempjurnal_jenisjurnal_id', 3);
        ...
        $this->dataset_db->insert_logs(
										array(
											'log_username' => $this->session->userdata('ba_username'),
											'log_node' => $_SERVER['REMOTE_ADDR'],
											'log_description' => 'User menampilkan jurnal voucher memorial',
